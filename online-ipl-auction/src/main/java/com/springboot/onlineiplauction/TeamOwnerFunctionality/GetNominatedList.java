...
public class  GetNominatedList {

	@RequestMapping(value = "/getNominatedList", method = RequestMethod.GET)
	public @ResponseBody
	ResponseEntity<CommonResponse> getNominatedList() {
		CommonResponse result;
		DatabaseConnection connection = new DatabaseConnection();
		if (connection.SQLDatabaseConnection() != null) {
			List<AdminResponse> listAdminResponse = new ArrayList<>();
			Statement statement;
			String query = "select * from playerdetails where isPlayer = 1 and isNominated = 1";
